        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationTime = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    DurationInMonths = table.Column<int>(type: "int", nullable: false),
                    CanReserveTrainings = table.Column<bool>(type: "bit", nullable: false),
                    CanAccessGroupTraining = table.Column<bool>(type: "bit", nullable: false),
                    CanAccessPersonalTraining = table.Column<bool>(type: "bit", nullable: false),
                    CanReceiveTrainingPlans = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainingTypes_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrainingTypes_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HourlyRate = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    Removed = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedById = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employments_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Employments_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IndividualTrainings_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IndividualTrainings_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IndividualTrainings_Employees_TrainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrainingPlans_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrainingPlans_Employees_TrainerId",
                        column: x => x.TrainerId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GymMemberships_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GymMemberships_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GymMemberships_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GymMemberships_MembershipPlans_MembershipPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupTrainings_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupTrainings_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupTrainings_Employees_TrainerId",
                        column: x => x.TrainerId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupTrainings_TrainingTypes_TrainingTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainingPlanSessions_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrainingPlanSessions_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_GymMemberships_GymMembershipId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupTrainingParticipations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupTrainingParticipations_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupTrainingParticipations_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrainingPlanSessionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Exercises_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Exercises_TrainingPlanSessions_TrainingPlanSessionId",
                        column: x => x.TrainingPlanSessionId,
                        principalTable: "TrainingPlanSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employments_UpdatedById",
                table: "Employments",
                column: "UpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exercises_TrainingPlanSessionId",
                table: "Exercises",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupTrainingParticipations_CreatedById",
                table: "GroupTrainingParticipations",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupTrainingParticipations_UpdatedById",
                table: "GroupTrainingParticipations",
                column: "UpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupTrainings_TrainingTypeId",
                table: "GroupTrainings",
                column: "TrainingTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupTrainings_UpdatedById",
                table: "GroupTrainings",
                column: "UpdatedById");

            migrationBuilder.CreateIndex(
                name: "IX_GymMemberships_ClientId",
                table: "GymMemberships",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_GymMemberships_CreatedById",
                table: "GymMemberships",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_GymMemberships_MembershipPlanId",
                table: "GymMemberships",
                column: "MembershipPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_GymMemberships_UpdatedById",
                table: "GymMemberships",
                column: "UpdatedById");

            migrationBuilder.CreateIndex(
                name: "IX_IndividualTrainings_ClientId",
                table: "IndividualTrainings",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_IndividualTrainings_CreatedById",
                table: "IndividualTrainings",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IndividualTrainings_UpdatedById",
                table: "IndividualTrainings",
                column: "UpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_GymMembershipId",
                table: "Payments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingPlans_UpdatedById",
                table: "TrainingPlans",
                column: "UpdatedById");

            migrationBuilder.CreateIndex(
                name: "IX_TrainingPlanSessions_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingPlanSessions_UpdatedById",
                table: "TrainingPlanSessions",
                column: "UpdatedById");

            migrationBuilder.CreateIndex(
                name: "IX_TrainingTypes_CreatedById",
                table: "TrainingTypes",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_TrainingTypes_UpdatedById",
                table: "TrainingTypes",
                column: "UpdatedById");
        }
