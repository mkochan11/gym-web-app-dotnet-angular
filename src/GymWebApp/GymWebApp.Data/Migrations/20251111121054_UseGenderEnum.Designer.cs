...
namespace GymWebApp.Data.Migrations
{
    ...
    [Migration("20251111121054_UseGenderEnum")]
    partial class UseGenderEnum
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymWebApp.Data.Entities.Abstract.BaseUserEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymWebApp.Data.Entities.Client", b =>
                {
                    b.HasBaseType("GymWebApp.Data.Entities.Abstract.BaseUserEntity");
            ...
            modelBuilder.Entity("GymWebApp.Data.Entities.Abstract.AuditableEntity", b =>
                {
                    b.HasOne("GymWebApp.Data.Entities.Abstract.BaseUserEntity", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GymWebApp.Data.Entities.Abstract.BaseUserEntity", "UpdatedBy")
                        .WithMany()
